	...
	Panel_Setting(Panel_Overview panel_Overview) {
...

		{
			...
			final AbsolutePanel confirm = new AbsolutePanel();
			{
				...
				Hyperlink hyperlink = new Hyperlink("« Back to Calendar",
						"back");
				DOM.setStyleAttribute(hyperlink.getElement(), "fontSize",
						"10pt");
			...
			FlexTable flexTable_2 = new FlexTable();
			{
				...
				DOM.setStyleAttribute(radioButton_Male.getElement(),
						"fontSize", "10pt");
				radioButton_Male.setText("Male");
				DOM.setStyleAttribute(radioButton_Female.getElement(),
						"fontSize", "10pt");
			...
			FlexTable flexTable_3 = new FlexTable();
			{
				...
				DOM.setStyleAttribute(textBox_Age.getElement(), "fontSize",
						"10pt");
			...
			FlexTable flexTable_6 = new FlexTable();
			{
				...
				DOM.setStyleAttribute(textBox_Tel.getElement(), "fontSize",
						"10pt");
				textBox_Tel
